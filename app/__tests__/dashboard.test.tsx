/**
 * Component tests for the Annotation Analytics Dashboard.
 * Adapted from main (Jest) for Vitest + Testing Library on Remix.
 */

import React from 'react';
import { describe, it, expect, vi } from 'vitest';
import { render, screen, fireEvent } from '@testing-library/react';
import { DashboardChartCard } from '~/routes/projects.annotation-dashboard/dashboard/DashboardChartCard';
import { DashboardKpiRow } from '~/routes/projects.annotation-dashboard/dashboard/DashboardKpiRow';
import { DashboardTabs } from '~/routes/projects.annotation-dashboard/dashboard/DashboardTabs';
import { AnnotationDashboardDemo } from '~/routes/projects.annotation-dashboard/dashboard/AnnotationDashboardDemo';
import { OverviewTab } from '~/routes/projects.annotation-dashboard/dashboard/tabs/OverviewTab';
import { ThroughputTab } from '~/routes/projects.annotation-dashboard/dashboard/tabs/ThroughputTab';
import { ErrorsTab } from '~/routes/projects.annotation-dashboard/dashboard/tabs/ErrorsTab';
import { TeamPerformanceTab } from '~/routes/projects.annotation-dashboard/dashboard/tabs/TeamPerformanceTab';
import { CapacityForecastingTab } from '~/routes/projects.annotation-dashboard/dashboard/tabs/CapacityForecastingTab';
import { AlertsTab } from '~/routes/projects.annotation-dashboard/dashboard/tabs/AlertsTab';
import { SEED_DATA } from '~/routes/projects.annotation-dashboard/dashboard/dashboardData';
...
vi.mock('~/routes/projects.annotation-dashboard/dashboard/useLiveKpis', () => ({
  useLiveKpis: () => ({
...
function getTabProps() {
  return { kpis: MOCK_KPIS, isDark: false, data: SEED_DATA };
}
...
describe('<DashboardTabs />', () => {
  it('renders all tab buttons', () => {
    render(<DashboardTabs active="overview" onChange={vi.fn()} />);
...
describe('<AlertsTab />', () => {
  ...
  it('renders in dark mode', () => {
    const { container } = render(
      <AlertsTab kpis={MOCK_KPIS} isDark={true} data={SEED_DATA} />
    );
    expect(container).toBeTruthy();
  });
});
